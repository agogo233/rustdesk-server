...
fn main() -> ResultType<()> {
    ...
    let args = format!(
        ...
        -u, --software-url=[URL] '[DEPRECATED] Sets download url of MyDesk software of newest version'
        ...
        , --webhook-key=[KEY] 'Optional separate key for webhook HMAC, defaults to --key'",
    );
    init_args(&args, "hbbs", "MyDesk ID/Rendezvous Server");
